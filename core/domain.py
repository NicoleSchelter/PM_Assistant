...
class Risk:
    ...
    def is_overdue(self) -> bool:
        ...
        if self.target_resolution_date is None:
            return False
        return (self.status in [RiskStatus.OPEN, RiskStatus.IN_PROGRESS] and 
                date.today() > self.target_resolution_date)
    ...
    def update_status(self, new_status: RiskStatus, note: str = "") -> None:
        ...
        if new_status in [RiskStatus.MITIGATED, RiskStatus.CLOSED] and self.actual_resolution_date is None:
