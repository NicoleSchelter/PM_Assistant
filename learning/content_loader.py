            ...
            for guidance_file in content_dir.glob(pattern + ".md"):
                try:
                    ...
                    guidance_content.append(
                        {"title": self._format_title(guidance_file.stem), "content": content}
                    )
        ...
        if template_dir.exists() and template_dir.is_dir():
            for template_file in template_dir.glob("*.md"):
                try:
                    ...
                    templates.append(
                        {"name": self._format_title(template_file.stem), "content": content}
                    )
        ...
        if examples_dir.exists() and examples_dir.is_dir():
            for example_file in examples_dir.glob("*.md"):
                try:
                    ...
                    examples.append(
                        {"name": self._format_title(example_file.stem), "content": content}
                    )
