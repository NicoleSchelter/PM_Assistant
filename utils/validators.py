...
def validate_list_of_strings(value: List[str], field_name: str, allow_empty: bool = True) -> List[str]:
    """
...
def validate_date_string(date_string: str, field_name: str, allow_empty: bool = False) -> Optional[str]:
    """
...
def validate_currency_amount(value: Union[str, int, float], field_name: str, allow_negative: bool = False) -> Optional[float]:
    """
