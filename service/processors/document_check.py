...
from logic.models.models import DocumentType, FileFormat, FileInfo, ProcessingResult
from service.processors.base_processor import BaseProcessor
from ui.common.exceptions import FileProcessingError, ValidationError
...
class DocumentCheckProcessor(BaseProcessor):
    ...
    def _analyze_documents(
        self, files: List[FileInfo], required_docs_config: List[Dict[str, Any]]
    ) -> Dict[str, Any]:
        """
            ...
            if matching_files:
                ...
                for file_info in matching_files:
                    ...
                    if file_format in expected_formats:
                        ...
                        logger.warning(
                            f"Format mismatch for {doc_name}: got {file_format}, expected {expected_formats}"
                        )
    ...
    def _is_file_accounted_for(
        self, file_info: FileInfo, required_docs_config: List[Dict[str, Any]]
    ) -> bool:
        """
    ...
    def _generate_document_report(
        self, analysis: Dict[str, Any], files: List[FileInfo]
    ) -> Dict[str, Any]:
        """
    ...
    def _generate_recommendations(
        self, analysis: Dict[str, Any], summary: Dict[str, Any]
    ) -> List[str]:
        """
