...
from logic.models.models import FileInfo, ProcessingResult
from data.handlers.markdown_handler import MarkdownHandler
from service.learning.content_loader import ContentLoader
from service.learning.presenter import Presenter
from service.processors.base_processor import BaseProcessor
from ui.common.error_handling import error_context, handle_errors, safe_execute
from ui.common.exceptions import DataExtractionError, FileProcessingError
...
class LearningModuleProcessor(BaseProcessor):
    ...
    def __init__(self):
        ...
        self.default_content_paths = ["./learning/modules", "./content/learning", "./docs/learning"]
    ...
    def process(self, files: List[FileInfo], config: Dict[str, Any]) -> ProcessingResult:
        ...
        try:
            ...
            # Maintain backward compatibility by wrapping in learning_content
            result_data = {
            ...
            # Also provide direct access to main content for newer tests
            result_data.update(formatted_content)
    ...
    def _load_learning_content(
        self, content_path: str, relevant_topics: List[str]
    ) -> Dict[str, Any]:
        """
    ...
    def _load_content_from_directory(
        self, content_dir: Path, relevant_topics: List[str]
    ) -> Dict[str, Any]:
        """
        ...
        """
        content = {"topics": {}, "general_guidance": [], "templates": [], "examples": []}
...
"""
    ...
    def _generate_learning_recommendations(
        self, files: List[FileInfo], relevant_topics: List[str]
    ) -> List[str]:
        """
    ...
    def _format_learning_content(
        ...
        """
        return self.presenter.present_learning_content(
            learning_content, recommendations, relevant_topics
        )
