...
class TestPresenter:
    ...
    def test_initialization(self):
        ...
        assert presenter.learning_categories["stakeholder_analysis"] == "Stakeholder Analysis Strategies"
    
    def test_present_learning_content_complete(self, sample_learning_content, 
                                             sample_recommendations, sample_relevant_topics):
    ...
    def test_create_learning_overview(self, sample_learning_content, sample_relevant_topics):
        ...
        overview = presenter._create_learning_overview(sample_learning_content, sample_relevant_topics)
    ...
    def test_create_learning_overview_missing_topics(self):
        ...
        assert "0 of 2 relevant topics" in overview["summary"]
    ...
    def test_format_recommendations(self, sample_recommendations):
        ...
        assert rec1["category"] in ["risk_management", "stakeholder_management", "project_planning", "quality_management", "general"]
...
"""
    ...
    def test_create_overview_summary_variations(self):
        ...
        assert "2 relevant topics identified. Using default content" in summary
