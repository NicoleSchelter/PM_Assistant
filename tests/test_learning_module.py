...
"""
    ...
    def test_format_learning_content(self, processor):
        ...
        learning_content = {
            ...
            "general_guidance": [
                {"title": "Test Guidance", "content": "Test content"}
            ],
            "templates": [],
            "examples": []
        }
    ...
    def test_process_with_exception(self, processor, sample_files, sample_config):
        ...
        with patch.object(processor, '_identify_relevant_topics', side_effect=Exception("Test error")):
            result = processor.process(sample_files, sample_config)
