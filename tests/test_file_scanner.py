...
class TestFileScanner:
    ...
    def test_init_custom_configuration(self):
        ...
        custom_patterns = {
            DocumentType.CHARTER: ["*custom*charter*"]
        }
    ...
    def test_scan_directory_include_hidden(self, scanner, temp_project_dir):
        ...
        files_with_hidden = scanner.scan_directory(
            temp_project_dir, 
            include_hidden=True
        )
        files_without_hidden = scanner.scan_directory(
            temp_project_dir, 
    ...
    def test_scan_nonexistent_directory(self, scanner):
        ...
        with pytest.raises(FileProcessingError, match="Failed to scan directory.*Directory does not exist"):
    ...
    def test_match_document_patterns_custom_patterns(self, scanner):
        ...
        custom_patterns = {
            DocumentType.CHARTER: ["*custom*", "*special*"]
        }
...
class TestFileScannerEdgeCases:
    ...
    def test_scanner_with_very_restrictive_patterns(self):
        ...
        custom_patterns = {
            DocumentType.CHARTER: ["exactly_this_name.md"]
        }
