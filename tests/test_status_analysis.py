...
from core.models import FileInfo, FileFormat, DocumentType, ProjectStatus
...
class TestStatusAnalysisProcessor:
    ...
    def test_extract_all_data(self, mock_stakeholder_ext, mock_milestone_ext, 
                             mock_deliverable_ext, mock_risk_ext, processor, 
                             complete_file_set, sample_risks, sample_deliverables,
                             sample_milestones, sample_stakeholders):
    ...
    def test_compile_project_status(self, processor, sample_risks, sample_deliverables,
                                   sample_milestones, sample_stakeholders):
    ...
    def test_calculate_health_score(self, processor, sample_risks, sample_deliverables,
                                   sample_milestones, sample_stakeholders):
    ...
    def test_identify_critical_issues(self, processor, sample_risks, sample_deliverables,
                                     sample_milestones, sample_stakeholders):
    ...
    def test_generate_recommendations(self, processor, sample_risks, sample_deliverables,
                                     sample_milestones, sample_stakeholders):
    ...
    def test_process_successful(self, mock_extract, processor, complete_file_set, 
                               sample_config, sample_risks, sample_deliverables,
                               sample_milestones, sample_stakeholders):
    ...
    @patch.object(StatusAnalysisProcessor, '_extract_all_data')
    def test_process_with_extraction_error(self, mock_extract, processor, 
                                          complete_file_set, sample_config):
    ...
    def test_generate_status_report(self, processor, sample_risks, sample_deliverables,
                                   sample_milestones, sample_stakeholders, complete_file_set):
