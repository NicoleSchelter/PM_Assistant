...
from main import cli, analyze, detect_mode, list_files, status
from core.models import OperationMode, ProcessingResult, ModeRecommendation, FileInfo, DocumentType
...
class TestStatusCommand:
    ...
    def setup_method(self):
        ...
        self.sample_processor_info = {
            'document_check': {
                'name': 'Document Check Processor',
                'version': '1.0.0'
            },
            'status_analysis': {
                'name': 'Status Analysis Processor',
                'version': '1.0.0'
            }
        }
