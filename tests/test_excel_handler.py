...
class TestExcelHandler:
    ...
    def test_validate_structure_password_protected(
        self, mock_load_workbook, handler, temp_excel_file
    ):
    ...
    @patch("openpyxl.load_workbook")
    def test_validate_structure_permission_denied(
        self, mock_load_workbook, handler, temp_excel_file
    ):
    ...
    def test_create_field_mappings_risk(self, handler):
        ...
        sheet_info = {"columns": ["Risk Description", "Probability", "Impact", "Status", "Owner"]}
