...
from core.models import FileInfo, ValidationResult, ProcessingResult
...
class TestBaseProcessor:
    ...
    def test_concrete_implementation_works(self):
        ...
        from core.models import FileFormat, DocumentType
        files = [FileInfo(
    ...
    def test_missing_required_files(self):
        ...
        class TestProcessor(BaseProcessor):
            ...
            def process(self, files: List[FileInfo], config: Dict[str, Any]) -> ProcessingResult:
                return ProcessingResult(success=True, operation="test", data={}, errors=[], warnings=[], processing_time_seconds=0.0)
...
class TestBaseReporter:
    ...
    def test_concrete_implementation_works(self):
        ...
        class TestReporter(BaseReporter):
            ...
            def generate_report(self, data: ProcessingResult, output_path: str, config: Dict[str, Any]) -> str:
        ...
        result = ProcessingResult(success=True, operation="test", data={}, errors=[], warnings=[], processing_time_seconds=1.0)
