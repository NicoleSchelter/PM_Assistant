...
class TestMPPHandler(unittest.TestCase):
    ...
    def test_can_handle_no_processing_methods(self):
        ...
        with patch.object(self.handler, "_mpxj_available", False), patch.object(
            self.handler, "_pywin32_available", False
    ...
    def test_extract_data_all_methods_fail(self):
        ...
        with patch.object(self.handler, "_extract_with_mpxj") as mock_mpxj, patch.object(
            self.handler, "_extract_with_pywin32"
        ) as mock_pywin32, patch.object(self.handler, "_extract_with_xml_conversion") as mock_xml:
    ...
    def test_extract_data_mpxj_success(self):
        ...
        with patch.object(self.handler, "_mpxj_available", True), patch.object(
            self.handler, "_extract_with_mpxj", return_value=mock_data
        ):
    ...
    def test_extract_data_pywin32_fallback(self):
        ...
        with patch.object(self.handler, "_mpxj_available", True), patch.object(
            self.handler, "_pywin32_available", True
        ), patch.object(self.handler, "_extract_with_mpxj") as mock_mpxj, patch.object(
            self.handler, "_extract_with_pywin32", return_value=mock_data
        ):
    ...
    def test_extract_data_xml_fallback(self):
        ...
        with patch.object(self.handler, "_mpxj_available", False), patch.object(
            self.handler, "_pywin32_available", False
        ), patch.object(self.handler, "_xml_conversion_available", True), patch.object(
            self.handler, "_extract_with_xml_conversion", return_value=mock_data
        ):
    ...
    def test_extract_timeline_data_success(self):
        ...
        mock_data = {
            "project_info": {"start_date": "2024-01-01", "finish_date": "2024-12-31"},
            "tasks": [
                {
                    "id": "task_1",
                    "name": "Critical Task",
                    ...
                    "is_critical": True,
                    "predecessors": [{"id": "task_0", "type": "FS", "lag": 0}],
                }
            ],
            "resources": [
                {
...
class TestMPPHandlerIntegration(unittest.TestCase):
    ...
    def test_method_priority_and_fallback(self):
        ...
        with patch.object(self.handler, "_mpxj_available", True), patch.object(
            ...
            self.handler, "_extract_with_mpxj", side_effect=mock_mpxj_extract
        ), patch.object(
            self.handler, "_extract_with_pywin32", side_effect=mock_pywin32_extract
        ), patch.object(
            self.handler, "_extract_with_xml_conversion", side_effect=mock_xml_extract
        ):
