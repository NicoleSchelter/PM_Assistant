...
"""
        ...
        config_data = {
            "project": {"name": "Test Integration Project", "default_path": str(project_path)},
            "required_documents": [
                {
            ...
            "modes": {
                ...
                "status_analysis": {"enabled": True, "output_formats": ["markdown"]},
    ...
    def test_engine_explicit_learning_module_mode(self, temp_workspace):
        ...
        processing_data = result.data["processing_data"]
        assert "learning_overview" in processing_data
        assert "topic_content" in processing_data
        assert "personalized_recommendations" in processing_data
