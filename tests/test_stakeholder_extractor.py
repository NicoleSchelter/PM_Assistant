            ...
            'tables': [
                {
                    ...
                    'rows': [
                        {'Stakeholder ID': 'SH001', 'Name': 'Test Stakeholder', 'Role': 'Manager', 'Email': 'test@example.com'}
                    ]
                }
            ],
            'sections': [],
...
class TestStakeholderExtractionFromExcel:
    ...
    def test_extract_from_excel(self, mock_extract_sheet, mock_is_stakeholder_sheet):
        ...
        mock_data = {
            'sheets': {
                'Stakeholders': {'data': [['Stakeholder ID', 'Name'], ['SH001', 'Test Stakeholder']]},
...
class TestColumnMapping:
    ...
    def test_create_column_mapping(self):
        ...
        headers = ['Stakeholder ID', 'Name', 'Role', 'Organization', 'Email', 'Phone', 'Influence', 'Interest']
    ...
    def test_create_column_mapping_variations(self):
        ...
        headers = ['ID', 'Contact Name', 'Position', 'Company', 'E-mail', 'Mobile', 'Power', 'Engagement']
        mapping = self.extractor._create_column_mapping(headers)
