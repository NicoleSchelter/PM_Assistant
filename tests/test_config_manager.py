...
class TestConfigManager:
    ...
    def test_load_config_success(self):
        ...
        valid_config = {
            "project": {"name": "Test Project", "default_path": "./test_path"},
            "required_documents": [
                {"name": "Test Doc", "patterns": ["*test*"], "formats": ["md"], "required": True}
            ],
            "modes": {
    ...
    def test_validate_config_missing_sections(self):
        ...
        incomplete_config = {
            "project": {"name": "Test", "default_path": "./test"}
    ...
    def test_get_project_config(self):
        ...
        config_manager = ConfigManager()
        config_manager.config_data = {"project": {"name": "Test Project", "default_path": "./test"}}
    ...
    def test_get_modes_config(self):
        ...
        config_manager = ConfigManager()
        test_modes = {"document_check": {"enabled": True}, "status_analysis": {"enabled": False}}
    ...
    def test_get_project_path(self):
        ...
        config_manager = ConfigManager()
        config_manager.config_data = {"project": {"default_path": "./custom_path"}}
    ...
    def test_is_mode_enabled_true(self):
        ...
        config_manager = ConfigManager()
        config_manager.config_data = {"modes": {"document_check": {"enabled": True}}}
    ...
    def test_is_mode_enabled_false(self):
        ...
        config_manager = ConfigManager()
        config_manager.config_data = {"modes": {"document_check": {"enabled": False}}}
